...
uses
  ...
  KhipoAPI.Produto.Controller in 'src\Controller\KhipoAPI.Produto.Controller.pas',
  KhipoAPI.Produto.Model in 'src\Model\KhipoAPI.Produto.Model.pas',
  KhipoAPI.WebModules in 'src\WebModule\KhipoAPI.WebModules.pas',
  KhipoAPI.RoleAuthHandler.Controller in 'src\Controller\KhipoAPI.RoleAuthHandler.Controller.pas';
...
begin
  Writeln('** KhipoAPI Server ** build ' + DMVCFRAMEWORK_VERSION);
